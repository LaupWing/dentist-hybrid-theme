    ...
    <div class="mx-auto flex max-w-7xl items-center justify-between rounded-full bg-white px-6 py-3 shadow-lg">
        ...
        <div class="hidden items-center gap-8 md:flex">
            <nav class="flex gap-6 text-sm font-bold text-slate-600">
                <a href="<?php echo esc_url(home_url('/')); ?>" class="transition-colors hover:text-indigo-700">
                    HOME
                </a>
                <a href="<?php echo esc_url(home_url('/services/')); ?>" class="transition-colors hover:text-indigo-700">
                    SERVICES
                </a>
                <a href="<?php echo esc_url(home_url('/doctors/')); ?>" class="transition-colors hover:text-indigo-700">
                    DOCTORS
                </a>
                <a href="<?php echo esc_url(home_url('/blog/')); ?>" class="transition-colors hover:text-indigo-700">
                    BLOG
                </a>
            </nav>
        ...
        <div class="absolute left-0 right-0 top-full mt-4 hidden flex-col overflow-hidden rounded-xl bg-white shadow-xl peer-checked:flex md:hidden">
            <nav class="flex flex-col p-4">
                <a href="<?php echo esc_url(home_url('/')); ?>" class="border-b border-slate-100 py-3 text-center font-bold text-slate-700 hover:text-indigo-700">
                    HOME
                </a>
                <a href="<?php echo esc_url(home_url('/services/')); ?>" class="border-b border-slate-100 py-3 text-center font-bold text-slate-700 hover:text-indigo-700">
                    SERVICES
                </a>
                <a href="<?php echo esc_url(home_url('/doctors/')); ?>" class="border-b border-slate-100 py-3 text-center font-bold text-slate-700 hover:text-indigo-700">
                    DOCTORS
                </a>
                <a href="<?php echo esc_url(home_url('/blog/')); ?>" class="py-3 text-center font-bold text-slate-700 hover:text-indigo-700">
                    BLOG
                </a>
